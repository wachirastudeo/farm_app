    ...
    <>
      ...
      <header className="hidden lg:flex items-center justify-between px-8 py-6 border-b border-zinc-100 bg-white/80 backdrop-blur-md sticky top-0 z-10">
        <div className="flex items-center gap-3">
          <Link href="/planning" className="p-2 rounded-xl hover:bg-zinc-100 transition-colors text-zinc-500">
      ...
      <main className="lg:px-8 lg:py-6 lg:max-w-5xl lg:mx-auto max-w-2xl mx-auto px-6 py-8 pb-32">
        {/* Mobile header */}
        ...
        <form className="lg:grid lg:grid-cols-2 lg:gap-8 space-y-6 lg:space-y-0">
          {/* Left Column */}
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    <label className="relative cursor-pointer">
                      ...
                      <div className="h-12 flex items-center justify-center rounded-lg border border-[#c2c9bb] bg-[#ffffff] peer-checked:bg-[#ffdeac] peer-checked:border-[#4f3500] peer-checked:text-[#281900] transition-colors text-base font-kanit text-[#1a1c1b] hover:bg-[#f4f4f1]">ทุเรียน</div>
                    </label>
                    <label className="relative cursor-pointer">
                      <input className="peer sr-only" name="crop_type" type="radio" value="mangosteen" />
                      <div className="h-12 flex items-center justify-center rounded-lg border border-[#c2c9bb] bg-[#ffffff] peer-checked:bg-[#ffdeac] peer-checked:border-[#4f3500] peer-checked:text-[#281900] transition-colors text-base font-kanit text-[#1a1c1b] hover:bg-[#f4f4f1]">มังคุด</div>
                    </label>
                    <label className="relative cursor-pointer">
                      <input className="peer sr-only" name="crop_type" type="radio" value="rambutan" />
                      <div className="h-12 flex items-center justify-center rounded-lg border border-[#c2c9bb] bg-[#ffffff] peer-checked:bg-[#ffdeac] peer-checked:border-[#4f3500] peer-checked:text-[#281900] transition-colors text-base font-kanit text-[#1a1c1b] hover:bg-[#f4f4f1]">เงาะ</div>
                    </label>
                    <label className="relative cursor-pointer">
                      <input className="peer sr-only" name="crop_type" type="radio" value="longkong" />
                      <div className="h-12 flex items-center justify-center rounded-lg border border-[#c2c9bb] bg-[#ffffff] peer-checked:bg-[#ffdeac] peer-checked:border-[#4f3500] peer-checked:text-[#281900] transition-colors text-base font-kanit text-[#1a1c1b] hover:bg-[#f4f4f1]">ลองกอง</div>
                    </label>
                  </div>
                </div>
              </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <label className="relative cursor-pointer">
                      ...
                      <div className="h-12 flex items-center justify-center rounded-lg border border-[#c2c9bb] bg-[#ffffff] peer-checked:bg-[#2d5a27] peer-checked:border-[#154212] peer-checked:text-[#9dd090] transition-colors text-base font-kanit text-[#1a1c1b] hover:bg-[#f4f4f1]">เกรด A</div>
                    </label>
                    <label className="relative cursor-pointer">
                      <input className="peer sr-only" name="grade" type="radio" value="B" />
                      <div className="h-12 flex items-center justify-center rounded-lg border border-[#c2c9bb] bg-[#ffffff] peer-checked:bg-[#2d5a27] peer-checked:border-[#154212] peer-checked:text-[#9dd090] transition-colors text-base font-kanit text-[#1a1c1b] hover:bg-[#f4f4f1]">เกรด B</div>
                    </label>
                    <label className="relative cursor-pointer">
                      <input className="peer sr-only" name="grade" type="radio" value="mixed" />
                      <div className="h-12 flex items-center justify-center rounded-lg border border-[#c2c9bb] bg-[#ffffff] peer-checked:bg-[#e2e3e0] peer-checked:border-[#72796e] peer-checked:text-[#1a1c1b] transition-colors text-base font-kanit text-[#1a1c1b] hover:bg-[#f4f4f1]">คละเกรด</div>
                    </label>
                  </div>
                </div>
              </div>
